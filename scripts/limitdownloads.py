...
try:
	...
	if c.conf_auth_token() != '' :
		s.aria2.changeGlobalOption(c.conf_auth_token(), {'max-overall-download-limit': c.conf_cron_maxspeed() })
	else:
		s.aria2.changeGlobalOption({'max-overall-download-limit': c.conf_cron_maxspeed() })
